...
import 'package:online_classroom/models/submissions.dart';
                ...
                child: Column(
                  children: [
                    ...
                    if(widget.announcement.type == 'Assignment') DateTimeField(
                      decoration: InputDecoration(labelText: "Due Date", border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
