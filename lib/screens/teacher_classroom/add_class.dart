              ...
              child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        decoration: InputDecoration(labelText: "Class Name", border: OutlineInputBorder( borderRadius: BorderRadius.circular(10.0))),
                      ...
                      TextFormField(
                        decoration: InputDecoration(labelText: "Description", border: OutlineInputBorder( borderRadius: BorderRadius.circular(10.0))),
                        maxLines: 5,
                        onChanged: (val) {
                          setState(() {
                            description = val;
